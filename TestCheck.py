...
for isim in range(nsims):
    ...
    ax1.plot(tnumparts,numparts,color=colors[isim],linestyle=linestyles[isim],linewidth=1,label=str(isim))
    ...
    lines[isim].append(ax2.plot(xax,distrib_res,color=colors[isim],linestyle=linestyles[isim],linewidth=1, label=str(isim))[0])
    lines[isim].append(ax3.plot(xax,distrib_resph,color=colors[isim],linestyle=linestyles[isim],linewidth=1, label=str(isim))[0])
    ...
    lines[isim].append(ax4.plot(xax, ey,color=colors[isim],linestyle=linestyles[isim],linewidth=1, label=str(isim))[0])
    lines[isim].append(ax4.plot(xax, ez,color=colors[isim],linestyle=linestyles[isim],linewidth=1, label=str(isim))[0])
    lines[isim].append(ax4.plot(xax, by,color=colors[isim],linestyle=linestyles[isim],linewidth=1, label=str(isim))[0])
    lines[isim].append(ax4.plot(xax, bz,color=colors[isim],linestyle=linestyles[isim],linewidth=1, label=str(isim))[0])
    
    energy = np.loadtxt(path+'/BasicOutput/data/PhotonEnergy1Dx/%.6d.txt' % tmom)
    lines[isim].append(ax5.plot(xax, energy,color=colors[isim],linestyle=linestyles[isim],linewidth=1, label=str(isim))[0])
