...
namespace pfc {
    ...
    public:
        ...
        FunctionType getEx() { return funcEx; }
        FunctionType getEy() { return funcEy; }
        FunctionType getEz() { return funcEz; }
        FunctionType getBx() { return funcBx; }
        FunctionType getBy() { return funcBy; }
        FunctionType getBz() { return funcBz; }
        FunctionType getJx() { return funcJx; }
        FunctionType getJy() { return funcJy; }
        FunctionType getJz() { return funcJz; }
        ...
        FP getTime() { return globalTime; }////// !!!!!!
        void setTime(FP t) { globalTime = t; }////// !!!!!!
        void advanceTime(FP dt) { globalTime += dt; }////// !!!!!!
